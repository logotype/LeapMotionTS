...
module Leap
{
    ...
    export class Matrix
    {
         ...
         */
        public origin:Leap.Vector3 = new Vector3( 0, 0, 0 );

        /**
         * The rotation and scale factors for the x-axis.
         */
        public xBasis:Leap.Vector3 = new Vector3( 0, 0, 0 );

        /**
         * The rotation and scale factors for the y-axis.
         */
        public yBasis:Leap.Vector3 = new Vector3( 0, 0, 0 );

        /**
         * The rotation and scale factors for the z-axis.
         */
        public zBasis:Leap.Vector3 = new Vector3( 0, 0, 0 );
         ...
         *
         */
        constructor( x:Leap.Vector3, y:Leap.Vector3, z:Leap.Vector3, _origin:Leap.Vector3 = null )
        {
            this.xBasis = x;
            this.yBasis = y;
            this.zBasis = z;
         ...
         *
         */
        public setRotation( _axis:Leap.Vector3, angleRadians:number ):void
        {
            var axis:Leap.Vector3 = _axis.normalized();
         ...
         *
         */
        public transformPoint( inVector:Leap.Vector3 ):Leap.Vector3
        {
         ...
         *
         */
        public transformDirection( inVector:Leap.Vector3 ):Leap.Vector3
        {
        ...
        {
            var xBasis:Leap.Vector3 = new Vector3( 1, 0, 0 );
            var yBasis:Leap.Vector3 = new Vector3( 0, 1, 0 );
            var zBasis:Leap.Vector3 = new Vector3( 0, 0, 1 );
