...
module Leap
{
    ...
    export class Frame
    {
         ...
         *
         */
        public hand( id:number ):Leap.Hand
        {
            var returnValue:Leap.Hand = Leap.Hand.invalid();
         ...
         *
         */
        public gesture( id:number ):Leap.Gesture
        {
            var returnValue:Leap.Gesture = Leap.Gesture.invalid();
            var i:number = 0;
         ...
         *
         */
        public gestures( sinceFrame:Frame = null ):Leap.Gesture[]
        {
            if( !sinceFrame )
            {
                // The gestures recognized or continuing in this frame.
            ...
            else
            {
                ...
                var gesturesSinceFrame:Leap.Gesture[] = [];
                var i:number = 0;
                var j:number = 0;
         ...
         *
         */
        public rotationAxis( sinceFrame:Frame ):Leap.Vector3
        {
            var returnValue:Leap.Vector3;

            if ( sinceFrame && sinceFrame.rotation )
            {
                var vector:Leap.Vector3 = new Vector3( this.rotation.zBasis.y - sinceFrame.rotation.yBasis.z, this.rotation.xBasis.z - sinceFrame.rotation.zBasis.x, this.rotation.yBasis.x - sinceFrame.rotation.xBasis.y );
         ...
         *
         */
        public rotationAngle( sinceFrame:Frame, axis:Leap.Vector3 = null ):number
        {
            var returnValue:number = 0;
            if ( !axis )
            {
                var rotationSinceFrameMatrix:Leap.Matrix = this.rotationMatrix( sinceFrame );
            ...
            {
                var rotAxis:Leap.Vector3 = this.rotationAxis( sinceFrame );
         ...
         *
         */
        public rotationMatrix( sinceFrame:Frame ):Leap.Matrix
        {
         ...
         *
         */
        public translation( sinceFrame:Frame ):Leap.Vector3
        {
            var returnValue:Leap.Vector3;
