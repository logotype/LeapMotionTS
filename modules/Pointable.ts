...
module Leap
{
    ...
    export class Pointable
    {
         ...
         */
        public tipPosition:Leap.Vector3;

        /**
         * The rate of change of the tip position in millimeters/second.
         */
        public tipVelocity:Leap.Vector3;
        ...
        constructor()
        {
            this.direction = Leap.Vector3.invalid();
            this.tipPosition = Leap.Vector3.invalid();
            this.tipVelocity = Leap.Vector3.invalid();
        }
