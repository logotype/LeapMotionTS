 ...
 * 
 */
export class SwipeGesture extends gestureModule.Gesture
{
	/**
	 * The type value designating a swipe gesture. 
	 */
	static public classType:number = gestureModule.Gesture.TYPE_SWIPE;
	 ...
	 */
	public position:vectorModule.Vector3;
	 ...
	 */
	public startPosition:vectorModule.Vector3;
