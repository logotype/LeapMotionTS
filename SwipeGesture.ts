...
module Leap
{
     ...
     *
     */
    export class SwipeGesture extends Leap.Gesture
    {
        /**
         * The type value designating a swipe gesture.
         */
        static public classType:number = Leap.Gesture.TYPE_SWIPE;
         ...
         */
        public startPosition:Leap.Vector3;
