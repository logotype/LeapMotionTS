...
define(["require", "exports"], function(require, exports) {
                    ...
                    if (typeof json.pointables !== "undefined") {
                        ...
                        for (i; i < length; i++) {
                            ...
                            if (isTool) {
                                ...
                                pointable.dipPosition = new Vector3(json.pointables[i].dipPosition[0], json.pointables[i].dipPosition[1], json.pointables[i].dipPosition[2]);
                                pointable.pipPosition = new Vector3(json.pointables[i].pipPosition[0], json.pointables[i].pipPosition[1], json.pointables[i].pipPosition[2]);
                                pointable.mcpPosition = new Vector3(json.pointables[i].mcpPosition[0], json.pointables[i].mcpPosition[1], json.pointables[i].mcpPosition[2]);
                                pointable.type = json.pointables[i].type;
                                // Bones
                                bone = new Bone();
                                bone.type = 0 /* TYPE_METACARPAL */ ;
    ...
    (function(Type) {
         ...
         */
        Type[Type["TYPE_METACARPAL"] = 0] = "TYPE_METACARPAL";
        /**
         * Bone connecting to the palm
         */
        Type[Type["TYPE_PROXIMAL"] = 1] = "TYPE_PROXIMAL";
        /**
         * Bone between the tip and the base
         */
        Type[Type["TYPE_INTERMEDIATE"] = 2] = "TYPE_INTERMEDIATE";
        /**
         * Bone at the tip of the finger
         */
        Type[Type["TYPE_DISTAL"] = 3] = "TYPE_DISTAL";
    ...
    var Bone = (function() {
         ...
         * @since 2.0
         */
        Bone.prototype.isValid = function() {
         ...
         *
         */
        Bone.prototype.isEqualTo = function(other) {
            if (!this.isValid() || !other.isValid())
                return false;
            if (this.length != other.length)
                return false;
    ...
    (function(Type) {
         ...
         * The thumb.
         */
        Type[Type["TYPE_THUMB"] = 0] = "TYPE_THUMB";
        /**
         * The index or fore- finger.
         */
        Type[Type["TYPE_INDEX"] = 1] = "TYPE_INDEX";
        /**
         * The middle finger.
         */
        Type[Type["TYPE_MIDDLE"] = 2] = "TYPE_MIDDLE";
        /**
         * The ring finger.
         */
        Type[Type["TYPE_RING"] = 3] = "TYPE_RING";
        /**
         * The pinky or little finger.
         */
        Type[Type["TYPE_PINKY"] = 4] = "TYPE_PINKY";
    })(exports.Type || (exports.Type = {}));
    var Type = exports.Type;
    var Finger = (function(_super) {
        ...
        function Finger() {
             ...
             * @since 1.f
             */
        Finger.prototype.bone = function(boneIx) {
            switch (boneIx) {
                case 0 /* TYPE_METACARPAL */ :
                    return this.metacarpal;
                    break;
                case 1 /* TYPE_PROXIMAL */ :
                    return this.proximal;
                    break;
                case 2 /* TYPE_INTERMEDIATE */ :
         ...
         */
        Finger.prototype.positions = function() {
            var positionsVector = [];
...
//# sourceMappingURL=leapmotionts-2.2.0.js.map
