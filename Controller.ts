...
export class Controller
{
     ...
     */
    public frameHistory:frameModule.Frame[] = [];
     ...
     *
     */
    public frame( history:number = 0 ):frameModule.Frame
    {
        var returnValue:frameModule.Frame;

        if ( history >= this.frameHistory.length )
            returnValue = frameModule.Frame.invalid();
        else
