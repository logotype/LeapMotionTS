...
export class CircleGesture extends gestureModule.Gesture
{
	 ...
	 */
	public normal:vectorModule.Vector3;
	
	/**
	 * The Finger or Tool performing the circle gesture. 
	 */
	public pointable:pointableModule.Pointable;
	...
	{
		super();
		this.pointable = pointableModule.Pointable.invalid();
	}
}