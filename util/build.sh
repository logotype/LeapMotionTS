...
sed 's/class /export class /' ../build/cat.ts | sed 's/interface /export interface /' | sed 's/enum /export enum /' > ../build/leapmotionts-2.2.0.ts

echo "[Running TypeScript compiler...]"
tsc --declaration --module amd --target ES5 ../build/leapmotionts-2.2.0.ts

echo "[Running Closure Compiler...]"
java \
-jar ./build/compiler.jar \
--js_output_file ../build/leapmotionts-2.2.0.min.js \
--js ../build/leapmotionts-2.2.0.js
