...
sed 's/class /export class /' ../build/cat.ts | sed 's/interface /export interface /' | sed 's/enum /export enum /' > ../build/leapmotionts-1.0.9.ts

echo "[Running TypeScript compiler...]"
tsc --declaration --module amd --target ES5 ../build/leapmotionts-1.0.9.ts

echo "[Running Closure Compiler...]"
java \
-jar ./build/compiler.jar \
--js_output_file ../build/leapmotionts-1.0.9.min.js \
--js ../build/leapmotionts-1.0.9.js
