...
var Hand = (function () {
    ...
    Hand.prototype.rotationAxis = function (sinceFrame) {
        ...
        if(sinceFrame.hand(this.id)) {
            var vector = new vectorModule.Vector3(this.rotation.zBasis.y - sinceFrame.hand(this.id).rotation.yBasis.z, this.rotation.xBasis.z - sinceFrame.hand(this.id).rotation.zBasis.x, this.rotation.yBasis.x - sinceFrame.hand(this.id).rotation.xBasis.y);
