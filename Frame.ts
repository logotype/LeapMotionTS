...
export class Frame
{
	 ...
	 *
	 */
	public hand( id:number ):handModule.Hand
	{
		var returnValue:handModule.Hand = handModule.Hand.invalid();
	 ...
	 *
	 */
	public rotationAxis( sinceFrame:Frame ):vectorModule.Vector3
	{
		var returnValue:vectorModule.Vector3;

		if ( sinceFrame && sinceFrame.rotation )
		{
			var vector:vectorModule.Vector3 = new vectorModule.Vector3( this.rotation.zBasis.y - sinceFrame.rotation.yBasis.z, this.rotation.xBasis.z - sinceFrame.rotation.zBasis.x, this.rotation.yBasis.x - sinceFrame.rotation.xBasis.y );
	 ...
	 *
	 */
	public rotationAngle( sinceFrame:Frame, axis:vectorModule.Vector3 = null ):number
	{
		var returnValue:number = 0;
		if ( !axis )
		{
			var rotationSinceFrameMatrix:matrixModule.Matrix = this.rotationMatrix( sinceFrame );
		...
		{
			var rotAxis:vectorModule.Vector3 = this.rotationAxis( sinceFrame );
	 ...
	 *
	 */
	public rotationMatrix( sinceFrame:Frame ):matrixModule.Matrix
	{
	 ...
	 *
	 */
	public translation( sinceFrame:Frame ):vectorModule.Vector3
	{
		var returnValue:vectorModule.Vector3;
