...
(function (LeapMotion) {
    ...
    var Controller = (function () {
        function Controller(host) {
            ...
            this.connection.onmessage = this.onWebsocketMessageHandler;
        ...
        Controller.prototype.onWebsocketMessageHandler = function (data) {
            var i;
            var json;
            var currentFrame;
            var hand;
                ...
                for(i; i < length; ++i) {
                    ...
                    if(json["gestures"][i].handIds) {
                        ...
                        for(j; j < lengthInner; ++j) {
                            var gestureHand = this.getHandByID(currentFrame, json["gestures"][i].handIds[j]);
                    ...
                    if(json["gestures"][i].pointableIds) {
                        ...
                        for(j; j < lengthInner; ++j) {
                            var gesturePointable = this.getPointableByID(currentFrame, json["gestures"][i].pointableIds[j]);
                            if(gesturePointable) {
            ...
            this.frameHistory.unshift(this._frame);
